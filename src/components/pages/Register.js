...
const Register = () => {
    ...
    const [url, setUrl] = useState('auth/register');
            ...
            <div className="w-full max-w-xs">
                ...
                <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" >
                    ...
                    <div className="mb-4">
                        ...
                        <input onChange={(e) => setFullName(e.target.value)} value={full_name} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="full_name" type="text" placeholder="Full Name" />
                    </div>
